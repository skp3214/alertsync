...
import { hrUsernameValidation } from "@/lib/validation-schemas/hr-schema";
...
export async function POST(req: Request) {
    ...
    try {
        ...
        const validationResult = hrUsernameValidation.safeParse(body);
        ...
        const result = await hrService.checkUsernameAvailability(validationResult.data.username);
